      ...
      module gameLogic {
        ...
        /**
         * @return a new board generated randomly.
         **/
        ...
        /**
         * @return random pet number of A, B, C or D.
         **/
        ...
        /**
         * change mode to whether it is test mode. 
         **/
      ...
      /**
       * @return whether the system needs to shuffle the board.
       **/
      ...
      /**
       * @return shuffling the board to generate a wholy new board.
       **/
      ...
      /**
       * @return the best possible move based on current board.
       **/
      ...
      /**
       * @return The number of matches of pets calculated from match input.
       **/
     ...
     /** 
      * @return all the deltas that have movements in them (orginal pets are 
      *   replaced by new pets in these cells).
      **/
      ...
      /** 
       * @param stateAfterMove state before make move
       ...
       **/
        ...
        /**
         * checkMoveOk is designed for test purpose.
         **/
        ...
        /**
         * special function for checkMoveOk when game is running. Random pets will begenerated, normal
         * checkMoveOk won't pass. 
         **/
         export function checkMoveOkN(stateTransition: IStateTransition): void {
         }

         /**
          * This function is left for debugging purpose.
          **/
